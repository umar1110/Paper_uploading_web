...
import { getAllJournals } from "../../reducers/allJournalsReducer";
import AdminJournalCard from "../journals/AdminJournalCard";


function AllJournals() {
  const dispatch = useDispatch();
  const { journals, error, loading, filteredJournals } = useSelector(
    (state) => state.allJournals
  );
  ...
  const filterFormHandler = (e) => {
    ...
    console.log(payload)
    dispatch(getAllJournals(payload));
  };
      ...
      {loading ? (
        ...
        <>
          ...
          >
            ...
            <div className="ID m-2 items-center flex space-x-2">
                <div className="w-[20%]">
                  <label htmlFor="ID">MS_Id :</label>
                </div>
                <input
                  type="text"
                  placeholder="ID"
          ...
          >
            ...
            >
              ...
              <div className="Author m-2 items-center flex space-x-2">
                <div className="w-[20%]">
                  <label htmlFor="dateFilter">MS_ID :</label>
                </div>
